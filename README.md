...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Hi%20There!%20I'm%20ANWESHA%20👋&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32"/>
...
│  🎓 B.E. CSE @ RVCE | 📍IIT MADRA DATA SCIENCE, RVCE, Karnataka               |
└─────────────────────────────────────────────────────────┘
...
```mermaid
graph TB
    A[👨‍💻 Next.js Frontend] --> B[🔥 Flask Backend]
    B --> C[🗄️ PostgreSQL]
    B --> D[🤖 FLAN-T5 AI]
    D --> E[☁️ AWS Cloud]
    E --> F[⚡ 120KB Load Time]
